    ...
    def _run(self, img_path):
        ...
        payload = {
            "messages": [
                {
                    "role": "user",
                    "content": f'Describe the image of food, its ingredients, and dish name, only output in json with descriptions, ingredients and dish_name attrbiutes <img src="data:image/png;base64,{image_b64}" />'
                }
            ],
            "max_tokens": 1024,
            "temperature": 0.20,
